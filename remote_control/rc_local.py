...
class RemoteControl():
    def __init__(self):
        ...
        self.urlBosHerc = "http://35.183.34.135/trigger"
        self.timeDeltaHrs = 1
        self.remotes = dict()
        self.remotes["local"] = "http://localhost:8010/replay"
...
#            'Z__Basketball__NBA Regular Season__Chicago Bulls__
#               Cleveland Cavaliers__create__2021'
#        self.manufactureTail = \
#            'Z__Ice Hockey__NHL Regular Season__Dallas Stars__New York Rangers
#           __create_2020'
#        self.manufactureTail = \
#            'Z__Soccer__EPL__Manchester City__Arsenal__create__2020'
    ...
    def TriggerLocal(self):
        ...
        rBosLocal = requests.post(self.urlBosHerc, json=incident)
...
#        rBos3 = requests.post(self.urlBos3, json=incident)
    ...
    def EventEnter(self, timeDt):
        self.Create(self.remotes["local"], timeDt)
        print('local called')
